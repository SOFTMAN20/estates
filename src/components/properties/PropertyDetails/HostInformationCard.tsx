 ...
 * Includes in-app messaging system for guest-host communication
 */
...
import { Phone, MessageCircle, Shield, Home, Calendar, Mail, Send } from 'lucide-react';
...
const HostInformationCard: React.FC<HostInformationCardProps> = ({
  ...
  const handleInAppMessage = () => {
    ...
    if (!hostId) {
      console.error('Host ID is required for messaging');
      return;
    }
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-3 py-4">
            ...
            <div className="space-y-3">
              ...
              {!contactPhone && !whatsappPhone && !hostId && (
